...
SIGNAL \dut_instance|add_instance|dff_Q1|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|D[1]~2_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|dff_Q2|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|D[0]~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|dff_Q0|Q~q\ : std_logic;
...
SIGNAL \dut_instance|add_instance|dff_Q0|ALT_INV_Q~q\ : std_logic;
...
\dut_instance|add_instance|dff_Q0|ALT_INV_Q~q\ <= NOT \dut_instance|add_instance|dff_Q0|Q~q\;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|dff_Q0|ALT_INV_Q~q\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\dut_instance|add_instance|dff_Q0|Q~q\))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|dff_Q0|Q~q\,
	datac => datau(0),
...
-- Equation(s):
-- \dut_instance|add_instance|D[2]~1_combout\ = (\dut_instance|add_instance|dff_Q2|Q~q\ & (\dut_instance|add_instance|dff_Q0|Q~q\ & !\dut_instance|add_instance|dff_Q1|Q~q\)) # (!\dut_instance|add_instance|dff_Q2|Q~q\ & 
-- (!\dut_instance|add_instance|dff_Q0|Q~q\ & \dut_instance|add_instance|dff_Q1|Q~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|dff_Q2|Q~q\,
	datab => \dut_instance|add_instance|dff_Q0|Q~q\,
	datac => \dut_instance|add_instance|dff_Q1|Q~q\,
...
\dut_instance|add_instance|dff_Q1|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|dff_Q1|Q~q\);

-- Location: LCCOMB_X26_Y26_N6
\dut_instance|add_instance|D[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D[1]~2_combout\ = (!\dut_instance|add_instance|dff_Q2|Q~q\ & ((!\dut_instance|add_instance|dff_Q0|Q~q\) # (!\dut_instance|add_instance|dff_Q1|Q~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|dff_Q1|Q~q\,
	datab => \dut_instance|add_instance|dff_Q0|Q~q\,
	datac => \dut_instance|add_instance|dff_Q2|Q~q\,
	combout => \dut_instance|add_instance|D[1]~2_combout\);

-- Location: FF_X26_Y26_N7
\dut_instance|add_instance|dff_Q2|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|dff_Q2|Q~q\);

-- Location: LCCOMB_X26_Y26_N8
\dut_instance|add_instance|D[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|D[0]~0_combout\ = (!\dut_instance|add_instance|dff_Q1|Q~q\ & (\dut_instance|add_instance|dff_Q2|Q~q\ $ (\dut_instance|add_instance|dff_Q0|Q~q\)))
...
PORT MAP (
	dataa => \dut_instance|add_instance|dff_Q2|Q~q\,
	datac => \dut_instance|add_instance|dff_Q0|Q~q\,
	datad => \dut_instance|add_instance|dff_Q1|Q~q\,
	combout => \dut_instance|add_instance|D[0]~0_combout\);

-- Location: FF_X26_Y26_N9
\dut_instance|add_instance|dff_Q0|Q\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \dut_instance|add_instance|dff_Q0|Q~q\);
