...
-- Design Ports Information
-- output_vector[0]	=>  Location: PIN_41,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|MUX2x1_3|Y~0_combout\ : std_logic;
SIGNAL \add_instance|MUX2x1_3|Y~1_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|MUX2x1_3|Y~1_combout\,
	devoe => ww_devoe,
...
\add_instance|MUX2x1_3|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|MUX2x1_3|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[3]~input_o\) # ((\input_vector[1]~input_o\)))) # (!\input_vector[0]~input_o\ & (((!\input_vector[1]~input_o\ & \input_vector[2]~input_o\))))
...
PORT MAP (
	...
	combout => \add_instance|MUX2x1_3|Y~0_combout\);

-- Location: LCCOMB_X8_Y1_N18
\add_instance|MUX2x1_3|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|MUX2x1_3|Y~1_combout\ = (\input_vector[1]~input_o\ & ((\add_instance|MUX2x1_3|Y~0_combout\ & (\input_vector[5]~input_o\)) # (!\add_instance|MUX2x1_3|Y~0_combout\ & ((\input_vector[4]~input_o\))))) # (!\input_vector[1]~input_o\ & 
-- (((\add_instance|MUX2x1_3|Y~0_combout\))))
...
PORT MAP (
	...
	datad => \add_instance|MUX2x1_3|Y~0_combout\,
	combout => \add_instance|MUX2x1_3|Y~1_combout\);
