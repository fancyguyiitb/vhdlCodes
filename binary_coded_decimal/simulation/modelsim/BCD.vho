...
-- output_vector[2]	=>  Location: PIN_21,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- input_vector[2]	=>  Location: PIN_25,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|FULL_ADD2|NOR5|Y~0_combout\ : std_logic;
SIGNAL \input_vector[2]~input_o\ : std_logic;
SIGNAL \add_instance|FULL_ADD3|NOR8|Y~0_combout\ : std_logic;
SIGNAL \input_vector[3]~input_o\ : std_logic;
SIGNAL \add_instance|FULL_ADD4|NOR8|Y~0_combout\ : std_logic;
SIGNAL \add_instance|FULL_ADD4|NOR8|ALT_INV_Y~0_combout\ : std_logic;
SIGNAL \add_instance|FULL_ADD3|NOR8|ALT_INV_Y~0_combout\ : std_logic;
...
\add_instance|FULL_ADD4|NOR8|ALT_INV_Y~0_combout\ <= NOT \add_instance|FULL_ADD4|NOR8|Y~0_combout\;
\add_instance|FULL_ADD3|NOR8|ALT_INV_Y~0_combout\ <= NOT \add_instance|FULL_ADD3|NOR8|Y~0_combout\;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|FULL_ADD2|NOR5|Y~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|FULL_ADD3|NOR8|ALT_INV_Y~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|FULL_ADD4|NOR8|ALT_INV_Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|FULL_ADD2|NOR5|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|FULL_ADD2|NOR5|Y~0_combout\ = (\input_vector[1]~input_o\) # (!\input_vector[0]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|FULL_ADD2|NOR5|Y~0_combout\);
...
\add_instance|FULL_ADD3|NOR8|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|FULL_ADD3|NOR8|Y~0_combout\ = (\input_vector[1]~input_o\ $ (!\input_vector[0]~input_o\)) # (!\input_vector[2]~input_o\)
...
PORT MAP (
	...
	combout => \add_instance|FULL_ADD3|NOR8|Y~0_combout\);
...
\add_instance|FULL_ADD4|NOR8|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|FULL_ADD4|NOR8|Y~0_combout\ = (\input_vector[1]~input_o\ $ (\input_vector[0]~input_o\ $ (!\input_vector[2]~input_o\))) # (!\input_vector[3]~input_o\)
...
PORT MAP (
	...
	datac => \input_vector[0]~input_o\,
	datad => \input_vector[2]~input_o\,
	combout => \add_instance|FULL_ADD4|NOR8|Y~0_combout\);
