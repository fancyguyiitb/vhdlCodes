...
-- state_out[0]	=>  Location: PIN_130,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \datau[0]~10_combout\ : std_logic;
...
SIGNAL \datau[3]~20_combout\ : std_logic;
SIGNAL \datau[2]~16_combout\ : std_logic;
SIGNAL \datau[2]~17_combout\ : std_logic;
SIGNAL \datau[2]~18_combout\ : std_logic;
SIGNAL \datau[0]~12_combout\ : std_logic;
SIGNAL \datau[1]~13_combout\ : std_logic;
SIGNAL \datau[1]~14_combout\ : std_logic;
SIGNAL \datau[1]~15_combout\ : std_logic;
SIGNAL \datau[0]~11_combout\ : std_logic;
...
-- Equation(s):
-- \datau[0]~7_combout\ = (dut_input(5) & (!dut_input(4) & (dut_input(1) & dut_input(0)))) # (!dut_input(5) & ((dut_input(1)) # ((!dut_input(4) & dut_input(0)))))
...
-- Equation(s):
-- \datau[0]~8_combout\ = (dut_input(7)) # ((dut_input(2) & ((\datau[0]~7_combout\) # (!dut_input(6)))) # (!dut_input(2) & (\datau[0]~7_combout\ & !dut_input(6))))
...
-- Equation(s):
-- \datau[0]~9_combout\ = (!dut_input(3) & \datau[0]~8_combout\)
...
PORT MAP (
	datab => dut_input(3),
	datad => \datau[0]~8_combout\,
	combout => \datau[0]~9_combout\);

-- Location: LCCOMB_X27_Y26_N12
\datau[0]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[0]~3_combout\ = (dut_input(6) & (((dut_input(5) & !dut_input(1))) # (!dut_input(2)))) # (!dut_input(6) & (dut_input(5) & (!dut_input(2) & !dut_input(1))))
...
-- Equation(s):
-- \datau[0]~0_combout\ = (dut_input(6) & (dut_input(2) & (dut_input(5) $ (!dut_input(1))))) # (!dut_input(6) & (!dut_input(2) & (dut_input(5) $ (!dut_input(1)))))
...
-- Equation(s):
-- \datau[0]~4_combout\ = (\datau[0]~3_combout\) # ((\datau[0]~0_combout\ & (dut_input(4) & !dut_input(0))))
...
-- Equation(s):
-- \datau[0]~1_combout\ = (dut_input(4) & (dut_input(0) & (dut_input(3) $ (!dut_input(7))))) # (!dut_input(4) & (!dut_input(0) & (dut_input(3) $ (!dut_input(7)))))
...
-- Equation(s):
-- \datau[0]~2_combout\ = (\datau[0]~1_combout\ & \datau[0]~0_combout\)
...
-- Equation(s):
-- \datau[0]~5_combout\ = (dut_input(3) & (((\datau[0]~2_combout\)))) # (!dut_input(3) & ((\datau[0]~4_combout\) # ((dut_input(7)))))
...
-- Equation(s):
-- \datau[0]~6_combout\ = (dut_input(4) & ((dut_input(7) & ((\datau[0]~5_combout\) # (!dut_input(3)))) # (!dut_input(7) & (\datau[0]~5_combout\ & !dut_input(3))))) # (!dut_input(4) & (dut_input(7) $ (((dut_input(3))))))
...
PORT MAP (
	dataa => dut_input(4),
	datab => dut_input(7),
	datac => \datau[0]~5_combout\,
	datad => dut_input(3),
	combout => \datau[0]~6_combout\);

-- Location: LCCOMB_X27_Y26_N14
\datau[0]~10\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[0]~10_combout\ = (\datau[0]~9_combout\ & (dut_input(0) & ((dut_input(4)) # (!\datau[0]~6_combout\)))) # (!\datau[0]~9_combout\ & (((\datau[0]~6_combout\))))
...
PORT MAP (
	dataa => dut_input(4),
	datab => \datau[0]~9_combout\,
	datac => \datau[0]~6_combout\,
	datad => dut_input(0),
	combout => \datau[0]~10_combout\);
...
-- Equation(s):
-- \shift_reg~0_combout\ = (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (\io~q\ & \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\))
...
-- Equation(s):
-- \datau[3]~19_combout\ = (dut_input(3) & (((\datau[0]~0_combout\ & \datau[0]~1_combout\)) # (!dut_input(7))))
...
\datau[3]~20\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~20_combout\ = (\shift_reg~0_combout\ & (((\datau[3]~19_combout\)))) # (!\shift_reg~0_combout\ & (!\shift_reg~3_combout\ & (datau(3))))
...
PORT MAP (
	...
	datac => datau(3),
	datad => \datau[3]~19_combout\,
	combout => \datau[3]~20_combout\);
...
-- Equation(s):
-- \datau[2]~16_combout\ = (dut_input(6) & ((\datau[0]~5_combout\ & ((dut_input(7)) # (!dut_input(3)))) # (!\datau[0]~5_combout\ & (dut_input(7) & !dut_input(3))))) # (!dut_input(6) & ((dut_input(7) $ (dut_input(3)))))
...
-- Equation(s):
-- \datau[2]~17_combout\ = (\datau[0]~9_combout\ & (dut_input(2) & ((dut_input(6)) # (!\datau[2]~16_combout\)))) # (!\datau[0]~9_combout\ & (((\datau[2]~16_combout\))))
...
PORT MAP (
	...
	datad => \datau[0]~9_combout\,
	combout => \datau[2]~17_combout\);

-- Location: LCCOMB_X26_Y25_N2
\datau[2]~18\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[2]~18_combout\ = (\shift_reg~0_combout\ & ((\datau[2]~17_combout\))) # (!\shift_reg~0_combout\ & (datau(3)))
...
PORT MAP (
	...
	datad => \datau[2]~17_combout\,
	combout => \datau[2]~18_combout\);

-- Location: LCCOMB_X26_Y25_N22
\datau[0]~12\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[0]~12_combout\ = (\io~q\ & ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\)) # 
...
PORT MAP (
	clk => \altera_internal_jtag~TCKUTAPclkctrl_outclk\,
	d => \datau[2]~18_combout\,
	ena => \datau[0]~12_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => datau(2));
...
-- Equation(s):
-- \datau[1]~13_combout\ = (dut_input(5) & ((dut_input(3) & (\datau[0]~5_combout\ & dut_input(7))) # (!dut_input(3) & ((\datau[0]~5_combout\) # (dut_input(7)))))) # (!dut_input(5) & (dut_input(3) $ (((dut_input(7))))))
...
\datau[1]~14\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[1]~14_combout\ = (\datau[0]~9_combout\ & (dut_input(1) & ((dut_input(5)) # (!\datau[1]~13_combout\)))) # (!\datau[0]~9_combout\ & (((\datau[1]~13_combout\))))
...
PORT MAP (
	dataa => dut_input(1),
	datab => dut_input(5),
	datac => \datau[1]~13_combout\,
	datad => \datau[0]~9_combout\,
	combout => \datau[1]~14_combout\);

-- Location: LCCOMB_X26_Y25_N24
\datau[1]~15\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[1]~15_combout\ = (\shift_reg~0_combout\ & ((\datau[1]~14_combout\))) # (!\shift_reg~0_combout\ & (datau(2)))
...
PORT MAP (
	datab => datau(2),
	datac => \shift_reg~0_combout\,
	datad => \datau[1]~14_combout\,
	combout => \datau[1]~15_combout\);
...
\datau[0]~11\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[0]~11_combout\ = (\shift_reg~0_combout\ & (\datau[0]~10_combout\)) # (!\shift_reg~0_combout\ & ((datau(1))))
...
-- pragma translate_on
PORT MAP (
	dataa => \datau[0]~10_combout\,
	datab => datau(1),
	datac => \shift_reg~0_combout\,
	combout => \datau[0]~11_combout\);
